...
const Dashboard = () => {
  //if you logout from dashboard than login page will be open
  ...
  return (
    ...
    <ToastContainer
                ...
                {/* Same as */}
                <ToastContainer />
      {/* create form having name email username profile picture cover picture razorpay id razorpay secret key */}
