    ...
    return (
        <div className="container mx-auto px-8 md:px-4 py-8">
            ...
            <p className="text-lg mb-6">
                FIll My Pocket is a crowdfunding platform designed for creators to fund their projects with the support of their fans. It&apos;s a space where your fans can directly contribute to your creative endeavors by buying you a chai. Unlock the potential of your fanbase and bring your projects to life.
            </p>

            <h2 className="text-2xl font-semibold mb-4">How It Works</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="flex items-center mb-6">
                    <Image width={70} height={100} className="rounded-full mr-4" src="/group.gif" alt="Fans Want to Collaborate" />
                    <div>
                ...
                <div className="flex items-center mb-6">
                    <Image width={70} height={100} className="rounded-full mr-4" src="/coin.gif" alt="Support Through Chai" />
                    <div>
                        <h3 className="text-xl font-semibold mb-2">Support Through Donation</h3>
